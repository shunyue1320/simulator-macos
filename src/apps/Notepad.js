    ...
    <div className="w-full h-full bg-gray-100 text-gray-700 overflow-scroll px-8 py-6">
      <div className="charapter">
        ...
        <div className="paragraph mt-4">
          Hey there! I'm Jianbo Guo, <s>a dragon lost in human world</s> now an
      ...
      <div className="charapter mt-8">
        ...
        <div className="paragraph mt-4">
          ...
          <ul className="mt-2 list-disc list-inside">
            <li>
              Email:{" "}
              <a className="text-blue-500" href="mailto:tsunyue1320@gmail.com">
                tsunyue1320@gmail.com
              </a>{" "}
              /{" "}
              <a className="text-blue-500" href="mailto:guojianbo6026@163.com">
            ...
            <li>
              ...
              <a
                className="text-blue-500"
                href="https://www.linkedin.com/in/jianbo-guo-24192a1bb/"
                target="_blank"
                rel="noreferrer"
              >
                Jianbo Guo
